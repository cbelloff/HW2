...
def res():
    if request.method == 'GET':
        ...
        return str("Double your favorite number is ") + new 
...
def res2():
    if request.method == 'GET':
        ...
        neww=str(new)
        #return render_template("result.html",result = result)
        return "<b>" + str("You will be 100 in ") + "</b> <i>" + neww + "</i>" "<b>" + str(" years.") + "</b>"
